...
@section('content')
	...
	<div class="panel panel-default">
		...
		<div class="panel-footer" style="text-align:right">
			<a href="{{ url('correct', [$flashcard->id, $deckID[0]]) }}" class="btn btn-primary"><span class="glyphicon glyphicon-ok"></span></a>
			<a href="{{ url('incorrect', [$flashcard->id, $deckID[0]]) }}" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span></a>
		</div>
